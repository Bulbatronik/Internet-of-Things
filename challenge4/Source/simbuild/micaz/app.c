...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b6e458, const void *arg_0xb7b6e5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b1f8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79c9840), 
int (*key_eq_fn)(void *arg_0xb79c9c88, void *arg_0xb79c9e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78989b8, int arg_0xb7898b10);
static double RandomUniform(void );
...
#line 159
  sendAckC$rec_id[sim_node()] = __nesc_ntoh_uint16(msg->msg_counter.nxdata);

  sim_log_debug(162U, "radio_rec", "Message received at time %s \n", sim_time_string());
  sim_log_debug_clear(163U, "radio_pack", "Payload:");
  sim_log_debug_clear(164U, "radio_pack", "\t msg_type: %hhu", __nesc_ntoh_uint16(msg->msg_type.nxdata));
  sim_log_debug_clear(165U, "radio_pack", "\t msg_counter: %hhu", __nesc_ntoh_uint16(msg->msg_counter.nxdata));
  if (__nesc_ntoh_uint16(msg->msg_type.nxdata) == 2) {
      sim_log_debug_clear(166U, "radio_pack", "\t msg_value: %hhu\n", __nesc_ntoh_uint16(msg->value.nxdata));
    }
  else 
#line 167
    {
  ...
  sim_log_debug_clear(168U, "radio_rec", "\n");


  if (__nesc_ntoh_uint16(msg->msg_type.nxdata) == 1) {
...
#line 81
{
  ...
  if (err == SUCCESS) {
      ...
      sim_log_debug(155U, "radio", "Radio is on\n");

      if (TOS_NODE_ID == 1) {
          sim_log_debug(156U, "role", "Mote 1 starts sending REQ\n");
...
#line 97
{
  sim_log_debug(157U, "boot", "Radio stopped!\n");
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74d2010, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74d2010) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74d2010, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77f4650){
#line 75
  switch (arg_0xb77f4650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77f4650);
#line 75
      break;
#line 75
    }
...
{
#line 46
  my_msg_t *req = (my_msg_t *)sendAckC$Packet$getPayload(&sendAckC$packet[sim_node()], sizeof(my_msg_t ));

  sendAckC$counter[sim_node()]++;
  __nesc_hton_uint16(req->msg_type.nxdata, 1);
  __nesc_hton_uint16(req->msg_counter.nxdata, sendAckC$counter[sim_node()]);


  sim_log_debug(148U, "radio_send", "I am trying to send a REQUEST to node 2 at %s \n", sim_time_string());
  ...
  if (sendAckC$AMSend$send(2, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug(149U, "radio_send", "Trying to send REQ\n");
      sim_log_debug_clear(150U, "radio_pack", "Payload:");
      sim_log_debug_clear(151U, "radio_pack", "\t msg_type: %hhu", __nesc_ntoh_uint16(req->msg_type.nxdata));
      sim_log_debug_clear(152U, "radio_pack", "\t msg_counter: %hhu \n", __nesc_ntoh_uint16(req->msg_counter.nxdata));
      sim_log_debug_clear(153U, "radio_send", "\n");
    }
}
...
#line 182
{
  ...
  __nesc_hton_uint16(resp->msg_counter.nxdata, sendAckC$rec_id[sim_node()]);
  __nesc_hton_uint16(resp->value.nxdata, data);

  sim_log_debug(169U, "radio_send", "I am trying to send a RESPONSE to node 1 at %s \n", sim_time_string());

  sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]);


  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(170U, "radio_send", "Trying to send RESP\n");
      sim_log_debug_clear(171U, "radio_pack", "Payload:");
      sim_log_debug_clear(172U, "radio_pack", "\t msg_type: %hhu", __nesc_ntoh_uint16(resp->msg_type.nxdata));
      sim_log_debug_clear(173U, "radio_pack", "\t msg_counter: %hhu", __nesc_ntoh_uint16(resp->msg_counter.nxdata));
      sim_log_debug_clear(174U, "radio_pack", "\t msg_value: %hhu\n", __nesc_ntoh_uint16(resp->value.nxdata));
      sim_log_debug_clear(175U, "radio_rec", "\n");
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7353c70){
#line 83
  switch (arg_0xb7353c70) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7353c70);
#line 83
      break;
#line 83
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74d29f8, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74d29f8, addr, msg, len);
#line 80
...
#line 75
{
  sim_log_debug(154U, "boot", "Application is booted.\n");
  sendAckC$SplitControl$start();
}
...
#line 119
  if (&sendAckC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(158U, "radio_send", "Packet is sent\n");


      if (sendAckC$PacketAcknowledgements$wasAcked(buf)) {
          sim_log_debug_clear(159U, "radio_ack", "ACK is received at time %s \n", sim_time_string());

          if (TOS_NODE_ID == 1) {
              sendAckC$req_ack[sim_node()]++;
              sim_log_debug(160U, "radio_rec", "---------REQ-ACK #%hhu -------------\n\n", sendAckC$req_ack[sim_node()]);


              if (sendAckC$req_ack[sim_node()] == sendAckC$last_digit[sim_node()] + 1) {
          ...
          sim_log_debug_clear(161U, "radio_ack", "ACK is NOT received\n");
          return;
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$req_ack"))
  {
    *addr = (uintptr_t)&sendAckC$req_ack[__nesc_mote];
    *size = sizeof(sendAckC$req_ack[__nesc_mote]);
    return 0;
  }
